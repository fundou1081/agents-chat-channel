...
`tests/unit/v2/test_cross_platform.py` — 5 类, 17 tests:
...
跑: `pytest tests/unit/v2/test_cross_platform.py -v`
...
# 4. 跑
.venv\Scripts\python -m agents_chat.v2.main init --data-dir .\data_v2
.venv\Scripts\python -m agents_chat.v2.main run-all --data-dir .\data_v2 --agents qwencode claude --cli opencode
```
...
- `tests/unit/v2/test_cross_platform.py` — 17 跨平台 tests
